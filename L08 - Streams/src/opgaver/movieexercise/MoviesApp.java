...
//        }
        ...
        int countH = (int) movieList.stream().filter(m -> m.getTitle().startsWith("H")).count();
        System.out.println("The numer of movies starting with H: " + countH);
